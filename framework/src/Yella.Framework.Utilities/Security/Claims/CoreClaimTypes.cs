namespace Yella.Framework.Utilities.Security.Claims;
...
public static class CoreClaimTypes
{
    ...
    public const string Username = ClaimType2005Namespace + "/username";
    public const string FullName = ClaimType2005Namespace + "/fullname";
    public const string NameIdentifier = ClaimType2005Namespace + "/nameidentifier";
    public const string Avatar = ClaimType2005Namespace + "/avatar";
